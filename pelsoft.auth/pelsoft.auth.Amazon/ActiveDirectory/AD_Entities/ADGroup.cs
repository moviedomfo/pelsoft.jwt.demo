...
namespace pelsoft.auth.Amazon.ActiveDirectory
{
    ...
    public class ADGroup
    {
        ...
        readonly string _Name, _FirstName, _Category, _Domain, _DistinguishedName, _Description, _CN;
        ...
        public ActiveDirectoryGroupBE GetBE()
        {
            ActiveDirectoryGroupBE aDGroupBE = new ActiveDirectoryGroupBE();
            aDGroupBE.Category = this.Category;
            aDGroupBE.CN = this.CN;
            aDGroupBE.Description = this.Description;
            aDGroupBE.DistinguishedName = this.DistinguishedName;
            aDGroupBE.Domain = this.Domain;
            aDGroupBE.FirstName = this.FirstName;
            aDGroupBE.OU = this.OU.ToArray();
            return aDGroupBE;
        }
