...
namespace pelsoft.auth.Amazon.ActiveDirectory
{
    ...
    {
        private readonly List<FwkIdentity> _ActiveDirectoryUsers = null;
    ...
    public class FwkIdentity : ObjectDomain
    {
        #region {Declaraciones}
        private readonly List<ObjectDomainGroup> _ActiveDirectoryGroups = null;
        /// <summary>
        /// 
        /// </summary>
